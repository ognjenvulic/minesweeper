...
export const { setGameBoardValue, setGameLevel, setGameBoardStatus, clearMarkedBombs, markBomb, unMarkBomb} = gameBoardSlice.actions;
...
export const selectMarkedBombs = (state: RootState) => state.gameBoardSlice.markedBombs;
